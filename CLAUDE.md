...
- **LATEST (2025-08-27)**: **Smooth Acquisition-Maintenance Transition** - Implemented intelligent ease factor initialization ensuring seamless interval transitions from ACQUISITION to MAINTENANCE mode at Level 5. No more interval regression - acquisition intervals are preserved or improved when transitioning to SM2 spaced repetition system.
